...
std::string MtlBuilder::toString() const {
	...
	for (auto e : elements) {
		...
		ss << "Ka " << e->_ka.x << " " << e->_ka.y << " " << e->_ka.z << std::endl;
		ss << "Kd " << e->_kd.x << " " << e->_kd.y << " " << e->_kd.z << std::endl;
		ss << "Ks " << e->_ks.x << " " << e->_ks.y << " " << e->_ks.z << std::endl;
		ss << "Ke " << e->_ke.x << " " << e->_ke.y << " " << e->_ke.z << std::endl;

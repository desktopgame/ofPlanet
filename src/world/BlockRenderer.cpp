...
CubeRenderer & BlockRenderer::getLeftSlabRenderer() {
	return leftSlabRenderer;
}
...
CubeRenderer & BlockRenderer::getBackSlabRenderer() {
	return backSlabRenderer;
}
CubeRenderer & BlockRenderer::getTopSlabRenderer() {
	return topSlabRenderer;
}

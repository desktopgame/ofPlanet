#ifndef GAME_SCENE_SCENEMANAGER_HPP
#define GAME_SCENE_SCENEMANAGER_HPP
#include <memory>
#include <optional>
#include <string>
...
class Scene;
/**
 * SceneManager is manage a `Scene`.
...
class SceneManager {
       public:
         ...
         * @param scene
         */
        void put(const std::string& name, const std::shared_ptr<Scene>& scene);
        /**
         * remove a mapping.
         * @param name
         */
